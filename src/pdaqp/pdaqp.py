...
class _MPBase:
    """Base class for multi-parametric problems (shared solve/plot/codegen/tree logic)."""
    TH0: TH
    CRs: list
    solution: AnyValue
    solution_info: AnyValue

    def _init_base(self, problem_data, thmin, thmax):
        self._problem = problem_data
    ...
    def solve(self, settings=None):
        """ Computes the explicit solution to the parametric problem.
        ...
        """
        self.solution, self.solution_info = ParametricDAQP.mpsolve(self._problem, self.TH0, opts=settings)
    ...
    def plot_regions(self, fix_ids=None, fix_vals=None, backend='tikz'):
        """ A 2D plot of the critical regions of the parametric solution.
    ...
    def plot_solution(self, z_id=0, fix_ids=None, fix_vals=None, backend='tikz'):
        """ A 3D plot of component z_id of the parametric solution.
...
class MPVI(_MPBase):
    ...
    def __init__(self, H, G, f, A, E, b, thmin, thmax):
        ...
        self._init_base(self.mpVI, thmin, thmax)
...
class MPQP(_MPBase):
    ...
    def __init__(self, H,f,F,A,b,B, thmin,thmax, bounds_table=None, out_inds=None, eq_inds=None):
        ...
        self._init_base(self.mpQP, thmin, thmax)
